<!DOCTYPE html>
<?php
 foreach ($getserviceDetailbyid->result() AS $data) {}
$imgnew = $this->Product_model->loadserviceImg($data->id);
foreach ($imgnew->result() AS $imgnew3){}
$getservice = $this->Product_model->getservice($data->service_cate);  
...
<meta property="fb:app_id"        content="355179808591281"/>
         <meta property="og:url"           content="<?php echo base_url('Service/service_detail/').$data->id?>"/>
         <meta property="og:type"          content="website"/>
        <meta property="og:title"         content="<?php echo $data->service_topic?>"/>
        <meta property="og:description"   content="<?php echo strip_tags($data->service_detail)?>"/>
        <meta property="og:image"         content="<?php echo base_url('uploadfile/service/').$imgnew3->images_name?>"/>
			...
			<div class="row">
				<div class="col-md-12 text-center">
					<div class="inner-banner-detail">
                                            <p style="padding-bottom: 10px; text-align: left;"><a href="<?php echo base_url('Welcome')?>">Home</a><span> / </span><a href="<?php echo base_url('Service')?>">Services</a><span> / </span><a href="<?php echo base_url('Service/service/'.$service->topic.'/'.$data->service_cate)?>"><?php echo $service->topic?></a><span> / </span><?php echo $data->service_topic?></p>
				...
				<div class="blog-box">
                 ...
                 foreach ($imgnew->result() AS $imgnew2){?>
							<div class="item web_box">
								<img src="<?php echo base_url('uploadfile/service/').$imgnew2->images_name?>" alt="GOT AUTOMATION" style="width: 1140px;height: 641px">
							</div>
							 <?php }?>
						</div>
						<!--<div class="date-tag">
					...
					<div class="blog-box-deatil" style="padding:50px;">
						<h2><a href="javascript:void(0)"><?php echo $data->service_topic ?></a></h2>
						<div class="blog-tags">
							<a href="javascript:void(0)"><span>By</span> Admin,</a>
							<a href="javascript:void(0)"><span><i class="fa fa-calendar" aria-hidden="true"></i> <?php echo $this->Product_model->getDayMonthYear($data->date)?></a>
						</div>
						...
						<div class="blog-tags" style="width: 300px; padding: 10px;">
							...
							<a href="javascript:void(0)"><span>Share on</span></a>
                                                         ...
                                                         <div class="col-md-2" >
                                                        <a href="javascript:void(0)"  onclick="windowOpener('500', '700', 'facebook-share', 'https://www.facebook.com/sharer/sharer.php?u=<?php echo base_url('Service/service_detail/'.$data->id)?>')">
                                                             <img src="<?php echo base_url('HTML_2/images/facebook1.png')?>" alt="image" width="28px">
</a>
  </div>
                                                        <div class="col-md-2">
							<div class="line-it-button" data-lang="th" data-type="share-b" data-ver="3" data-url="<?php echo base_url('Service/service_detail/'.$data->id)?>" data-color="default" data-size="small" data-count="false" style="display: none;"></div>  
