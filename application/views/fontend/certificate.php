			...
			<div class="row">
				<div class="col-md-12 text-center">
					<div class="inner-banner-detail">
						<p style="padding-bottom: 10px; text-align: left;"><a href="<?php echo base_url('Welcome')?>">Home</a><span> / </span>Certification</p>
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="table-responsive cart_info">
								<table border="0" cellpadding="2" cellspacing="2" class="table table-condensed" style="background-color: #FDFDFD">
									<thead>
										<tr class="cart_menu" style="text-align: left;">
											<td class="description">Certificates</td>
											<td class="description"></td>
										</tr>
									</thead>
									<tbody>
                                                                            <?php foreach ($getcertificate->result() AS $Data){?>
										<tr>
											<td>
												<div class="cart_description">
													<p><strong><?php echo $Data->certificates?></strong></p>
												</div>
											</td>											
											<td>
												<div class="cart_description">
													<p><a href="<?php echo base_url('uploadfile/certificate/').$Data->file_name?>" target="_blank"><i class="fa fa-file-pdf-o" style="color: #b70b07; font-size: 18pt"></i> <?php echo $Data->file_name?></a></p>		
												</div>
											</td>																					
										</tr>
                                                                            <?php }?>
