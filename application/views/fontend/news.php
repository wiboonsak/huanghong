			...
			<div class="row">
				<div class="col-md-12 text-center">
					<div class="inner-banner-detail">
						<p style="padding-bottom: 10px; text-align: left;"><a href="<?php echo base_url('Welcome')?>">Home</a><span> / </span>News & Events</p>
				...
				<div class="row p-b-35">
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="logistic_news">
							<img src="<?php echo base_url('uploadfile/news/') . $firstImg ?>" alt="image" >
						</div>
					</div>
					<div class="col-md-8 col-sm-6 col-xs-12">
						<div class="logistic_news">
							<div class="logistic_news_detail">
								<h3><a href="<?php echo base_url('News/news_detail/').$data->id ?>"><?php echo  substr_replace($data->news_title,'....',35) ?></a></h3>
								<?php echo $this->Product_model->str_limit_html($data->news_detail,300)?>
								<a href="<?php echo base_url('News/news_detail/').$data->id ?>" class="btn btn-info">Read More</a>
								<span style="float: right"><i class="fa fa-calendar" aria-hidden="true"></i> <?php echo $this->Product_model->getDayMonthYear($data->news_date_add)?></span>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-md-12 text-center padding-top-50">
					<nav aria-label="...">
                                             <?php 
                                                    ...
                                                    ?>
						<ul class="pagination">
							<li <?php if($page == 1){?>class="isDisabled"<?php }?>> <a href="<?php echo base_url('News/Page/').$page2?> " >
								<span>
