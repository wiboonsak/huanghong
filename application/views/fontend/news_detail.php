				...
				<div class="blog-box">
                 ...
                 foreach ($imgnew->result() AS $imgnew2){?>
							<div class="item web_box">
								<img src="<?php echo base_url('uploadfile/news/').$imgnew2->images_name?>" alt="GOT AUTOMATION" style="width: 1140px;height: 641px">
							</div>
							 <?php }?>
						</div>
						<!--<div class="date-tag">
					...
					<div class="blog-box-deatil" style="padding:50px;">
						<h2><a href="javascript:void(0)"><?php echo $data->news_title ?></a></h2>
						<div class="blog-tags">
							<a href="javascript:void(0)"><span>By</span> Admin,</a>
							<a href="javascript:void(0)"><span><i class="fa fa-calendar" aria-hidden="true"></i> <?php echo $this->Product_model->getDayMonthYear($data->news_date_add)?></a>
						</div>
