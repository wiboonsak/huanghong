...
foreach ($referenceDetail->result() AS $data) {
    $firstImg = $this->Product_model->getreferenceImg($data->id);
                                    ?>
					<div class="col-md-4 col-sm-4 col-xs-12 item services_box text-center padding-top-50">
						...
						<div class="services_detail causes-box">
							...
							<a href="<?php echo base_url('Reference/Reference_detail/'.$data->id)?>"> Read More</a>
